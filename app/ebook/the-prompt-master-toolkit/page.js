    ...
    <>
      ...
      <div className='section-content'>
        <div className='content rich-text-block rich-text-block--newsletter'>
          ...
          <h2 className='tx-center'>Inserisci il tuo indirizzo<br/>e-mail per scaricare il toolkit!</h2>
          <NewsletterFormSlide 
            ...
            success=''
            error=''
            speechName='The Prompt Master Toolkit'
            slideLink='/file/tpm/the-prompt-master-toolkit.pdf'
          />
        </div>
      </div>
      <div className=''>
