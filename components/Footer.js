  ...
  return (
    <footer className={`${styles.footer}`}>
      <span className={`${styles.element}`}>
        <span className={`${styles.element__small}`}></span>
      </span>
      <div className={styles.footer__wrap}>
        ...
        <div className={`${styles.footer__row} ${styles.footer__row__text}`}>
          <span>the prompt master</span>
        </div>        
        <div className={`${styles.footer__row} ${styles.footer__row__credits}`}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="white" id="uuid-276052b2-2fc8-4a97-b8e4-993c0ddce8a3-b" viewBox="0 0 463.95 105">
            <g id="uuid-5a6d9eac-1cfc-4ee7-8f3c-ea4ac44a6cde-g">
          ...
          <div className={`${styles.footer__row__credits__stripe}`}> 
            <span>&copy; The Prompt Master - 2024</span> 
            <span>|</span> 
      ...
      <a href="https://calendar.app.google/uVDLew261bvqQyrTA" target="_blank" className='circleCta'>
        ...
        <div className='circleAnimation'>
          <svg width="100" height="100" viewBox="0 0 200 200" className='rotate'>
            ...
            <path id="circlePath" fill="transparent" d="M20,100a80,80 0 1,0 160,0a80,80 0 1,0 -160,0" />
            <text fontSize="16" fill="black">
              <textPath xlinkHref="#circlePath" startOffset="50%" textAnchor="middle">
                Vuoi usare ChatGPT per la tua produttività? -
              </textPath>
            </text>
          </svg>
        </div>
